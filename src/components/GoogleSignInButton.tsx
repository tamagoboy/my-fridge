...
export function GoogleSignInButton() {
  ...
  return (
    <button 
      className="w-full h-16 signature-gradient text-on-primary rounded-xl font-headline font-bold text-lg flex items-center justify-center space-x-3 active:scale-[0.98] transition-transform duration-200 editorial-shadow disabled:opacity-50"
    ...
    >
      ...
      <span>{isPending ? "移動中..." : "Googleでサインイン"}</span>
    </button>
  );
}